...
Los valores principales en XP son comunicación, simplicidad, feedback, coraje y respeto entre otros y son la base que justifica las prácticas. Necesitamos hacer estos valores explícitos a la hora de trabajar con las prácticas, ya que de otra manera, las practicas se deteriorarían rápidamente. Por ejemplo, practicamos pair programming porque valoramos la comunicación y el feedback rápido. Esto es necesario recordarlo a menudo para no perder el rumbo hacía donde vamos.

### Communication

La mayoría de problemas dentro de un equipo viene dado mas por una falta de comunicación que una falta de conocimiento técnico. Probablemente ya exista gente dentro del equipo que conozca la solución a ese problema o por lo menos tenga la suficiente orientación como para solucionarlo.
...
- Seguridad básica: no estar amenazado por el hambre, el daño físico tanto para ellos como sus seres queridos. El miedo a perder el trabajo socava esta necesidad.
